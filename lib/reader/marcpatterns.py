...
BFLITE_TRANSFORMS = {
    ...
    '100': onwork.materialize(BL+'Person', 
                              ...
                              links={BL+'name': subfield('a'), MARC+'numeration': subfield('b'), MARC+'titles': subfield('c'), BL+'date': subfield('d'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0'))), MARC+'additionalName': subfield('q')}),

    '110': onwork.materialize(BL+'Organization', 
                              values(BL+'creator', relator_property(subfield('e'), prefix=REL), relator_property(subfield('4'), prefix=REL)), 
                              unique=values(subfield('a'), subfield('b'), subfield('c'), subfield('d'), subfield('g'), subfield('j'), subfield('q'), subfield('u')),
                              links={BL+'name': subfield('a'), MARC+'subordinateUnit': subfield('b'), BL+'date': subfield('d'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0'))), MARC+'additionalName': subfield('q')}),

    '111': onwork.materialize(BL+'Meeting', 
                              values(BL+'creator', relator_property(subfield('e'), prefix=REL), relator_property(subfield('4'), prefix=REL)), 
                              unique=values(subfield('a'), subfield('b'), subfield('c'), subfield('d'), subfield('g'), subfield('j'), subfield('q'), subfield('u')),
                              links={BL+'name': subfield('a'), BL+'date': subfield('d'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0'))), MARC+'additionalName': subfield('q')}),
...
#
    ...
    '600': onwork.materialize(BL+'Person', 
                              ...
                              links={BL+'name': subfield('a'), MARC+'numeration': subfield('b'), MARC+'locationOfEvent': subfield('c'), BL+'date': subfield('d'), MARC+'generalSubdivision': subfield('x'), MARC+'chronologicalSubdivision': subfield('y'),  MARC+'formSubdivision': subfield('v'),  MARC+'geographicSubdivision': subfield('z'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0')))}),
    ...
    '611': onwork.materialize(BL+'Meeting', 
                              ...
                              links={BL+'name': subfield('a'), MARC+'locationOfEvent': subfield('c'), BL+'date': subfield('d'), MARC+'generalSubdivision': subfield('x'), MARC+'chronologicalSubdivision': subfield('y'), MARC+'formSubdivision': subfield('v'), MARC+'geographicSubdivision': subfield('z'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0')))}),
    ...
    '651': onwork.materialize(BL+'Place', 
                              ...
                              links={BL+'name': subfield('a'), BL+'date': subfield('d'), MARC+'generalSubdivision': subfield('x'), MARC+'chronologicalSubdivision': subfield('y'), MARC+'formSubdivision': subfield('v'), MARC+'geographicSubdivision': subfield('z'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0')))}),
    ...
    '655': onwork.materialize(BL+'Genre',
                              ...
                              links={BL+'name': subfield('a'), MARC+'source': subfield('2'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('0')))}),
    ...
    '765':  onwork.materialize(BL+'Work', 
                               REL+'isTranslationOf', 
                               unique=all_subfields, 
                               links={BL+'title': subfield('t'), MARC+'issn': subfield('x'), BL+'authorityLink': url(replace_from(AUTHORITY_CODES, subfield('w'))), MARC+'edition': subfield('b'), BL+'note': subfield('n'), MARC+'isbn': subfield('z')}),
