...
class transforms(object):
    ...
    def _process_fixed_length(self, typ, info, offset, params):
        ...
        PATTERNS = dict(
            ...
            Maps_007 = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.Map_007['SpecificMaterialDesignation'].get(info[i]))),
                3: lambda i: (None, I(self._vocab[MARC]+'color'), SLUG(self.COLOR.get(info[i]))),
                4: lambda i: (None, I(self._vocab[MARC]+'physicalMedium'), SLUG(self.PHYSICAL_MEDIUM.get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'typeOfReproduction'), SLUG(self.TYPE_OF_REPRODUCTION.get(info[i]))),
                6: lambda i: (None, I(self._vocab[MARC]+'productionReproductionDetails'), SLUG(self.PRODUCTION_REPRODUCTION_DETAILS.get(info[i]))),
                7: lambda i: (None, I(self._vocab[MARC]+'positiveNegativeAspect'), SLUG(self.POSITIVE_NEGATIVE_ASPECT.get(info[i]))),
            },
            ElectronicResource = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.ElectronicResource['SpecificMaterialDesignation'].get(info[i]))),
                3: lambda i: (None, I(self._vocab[MARC]+'color'), SLUG(self.COLOR.get(info[i]))),
                4: lambda i: (None, I(self._vocab[MARC]+'dimensions'), SLUG(self.ElectronicResource['Dimensions'].get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'sound'), SLUG(self.ElectronicResource['Sound'].get(info[i]))),
                ('slice', 6, 8): lambda i: (None, I(self._vocab[MARC]+'imageBitDepth'), marc_int(info[i])),
                9: lambda i: (None, I(self._vocab[MARC]+'fileFormat'), SLUG(self.ElectronicResource['FileFormats'].get(info[i]))),
                10: lambda i: (None, I(self._vocab[MARC]+'qualityAssuranceTargets'), SLUG(self.ElectronicResource['QualityAssuranceTargets'].get(info[i]))),
                11: lambda i: (None, I(self._vocab[MARC]+'antecedentSource'), SLUG(self.ElectronicResource['AntecedentSource'].get(info[i]))),
                12: lambda i: (None, I(self._vocab[MARC]+'levelOfCompression'), SLUG(self.ElectronicResource['LevelOfCompression'].get(info[i]))),
                13: lambda i: (None, I(self._vocab[MARC]+'reformattingQuality'), SLUG(self.ElectronicResource['ReformattingQuality'].get(info[i]))),
            },
            Globe = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.Globe['SpecificMaterialDesignation'].get(info[i]))),
                3: lambda i: (None, I(self._vocab[MARC]+'color'), SLUG(self.COLOR.get(info[i]))),
                4: lambda i: (None, I(self._vocab[MARC]+'physicalMedium'), SLUG(self.PHYSICAL_MEDIUM.get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'typeOfReproduction'), SLUG(self.TYPE_OF_REPRODUCTION.get(info[i]))),
            },
            TactileMaterial = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.TactileMaterial['SpecificMaterialDesignation'].get(info[i]))),
                ('slice', 3, 4): lambda i: (None, I(self._vocab[MARC]+'classOfBrailleWriting'), SLUG(self.TactileMaterial['ClassOfBrailleWriting'].get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'levelOfContraction'), SLUG(self.TactileMaterial['LevelOfContraction'].get(info[i]))),
                (6, 7, 8): lambda i: (None, I(self._vocab[MARC]+'brailleMusicFormat'), SLUG(self.TactileMaterial['BrailleMusicFormat'].get(info[i]))),
                9: lambda i: (None, I(self._vocab[MARC]+'specialPhysicalCharacteristics'), SLUG(self.TactileMaterial['SpecialPhysicalCharacteristics'].get(info[i]))),
            },
            ProjectedGraphic = {
            ...
            Microform = {
                ...
                3: lambda i: (None, I(self._vocab[MARC]+'positiveNegativeAspect'), SLUG(self.POSITIVE_NEGATIVE_ASPECT.get(info[i]))),
                4: lambda i: (None, I(self._vocab[MARC]+'dimensions'), SLUG(self.Microform['Dimensions'].get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'reductionRatioRange'), SLUG(self.Microform['ReductionRatioRange'].get(info[i]))),
                ('slice', 6, 8): lambda i: (None, I(self._vocab[MARC]+'reductionRatio'), info[i]),
            ...
            NonprojectedGraphic = {
                ...
                3: lambda i: (None, I(self._vocab[MARC]+'color'), SLUG(self.COLOR.get(info[i]))),
                4: lambda i: (None, I(self._vocab[MARC]+'primarySupportMaterial'), SLUG(self.SUPPORT_MATERIAL.get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'secondarySupportMaterial'), SLUG(self.SUPPORT_MATERIAL.get(info[i]))),
            },
            MotionPicture = {
               ...
               16: lambda i: (None, I(self._vocab[MARC]+'completeness'), SLUG(self.MotionPicture['Completeness'].get(info[i]))),
               ('slice', 17, 22): lambda i: (None, I(self._vocab[MARC]+'filmInspectionDate'), marc_date(info[i])),
            },
            Kit = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.Kit['SpecificMaterialDesignation'].get(info[i]))),
            },
            NotatedMusic = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.NotatedMusic['SpecificMaterialDesignation'].get(info[i]))),
            },
            RemoteSensingImage = {
                1: lambda i: (None, I(self._vocab[MARC]+'specificMaterialDesignation'), SLUG(self.RemoteSensingImage['SpecificMaterialDesignation'].get(info[i]))),
                3: lambda i: (None, I(self._vocab[MARC]+'altitudeOfSensor'), SLUG(self.RemoteSensingImage['AltitudeOfSensor'].get(info[i]))),
                4: lambda i: (None, I(self._vocab[MARC]+'attitudeOfSensor'), SLUG(self.RemoteSensingImage['AttitudeOfSensor'].get(info[i]))),
                5: lambda i: (None, I(self._vocab[MARC]+'cloudCover'), SLUG(self.RemoteSensingImage['CloudCover'].get(info[i]))),
                6: lambda i: (None, I(self._vocab[MARC]+'platformConstructionType'), SLUG(self.RemoteSensingImage['PlatformConstructionType'].get(info[i]))),
                7: lambda i: (None, I(self._vocab[MARC]+'platformUseCategory'), SLUG(self.RemoteSensingImage['PlatformUseCategory'].get(info[i]))),
                8: lambda i: (None, I(self._vocab[MARC]+'sensorType'), SLUG(self.RemoteSensingImage['SensorType'].get(info[i]))),
                ('slice', 9, 10): lambda i: (None, I(self._vocab[MARC]+'dataType'), SLUG(self.RemoteSensingImage['DataType'].get(info[i]))),
            },
            SoundRecording = {
